 ...
 */
public class WeiboCountData {
    private String total_user_id;
    ...
    public String getTotal_user_id() {
        return total_user_id;
    }

    public void setTotal_user_id(String total_user_id) {
        this.total_user_id = total_user_id;
    }
